...
class config:
    def __init__(self, n_node=36, node_input=3, node_output=8, num_head=2, learning_rate_critic=4e-5, learning_rate_actor=4e-7, reward_dacay=0.99, batch=256, memory_capacity=2000, target_replace_iter=30, tau=0.05):
